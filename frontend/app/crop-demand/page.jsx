  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-7xl">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-12">
        <div>
          <h1 className="text-4xl font-bold text-green-800 mb-2">Demand Crops</h1>
          <p className="text-gray-600 max-w-2xl">
            Browse available crop demands from buyers or create your own demand listing.
          </p>
        </div>
      ...
      {isLoading ? (
        ...
        <div className="bg-red-50 border border-red-200 rounded-lg p-6 text-center">
          <p className="text-red-600">Error fetching demands. Please try again later.</p>
        </div>
              ...
              <CardFooter className="flex gap-3 pt-0 pb-5">
                ...
                <Button
                  ...
                  className={cn(
                    ...
                    deletingId === demand.demand_id ? "bg-red-400" : "bg-red-500 hover:bg-red-600",
                  )}
