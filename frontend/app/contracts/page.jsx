  ...
  useEffect(() => {
    ...
    ws.current.onmessage = (event) => {
      ...
      if (data.data) {
        ...
        const pendingContracts = transformedContracts.filter(
          (c) => c.status === "pending"
        );
    ...
    if (
      ...
      setTimeout(() => {
        setApprovingIds((prev) =>
          prev.filter((id) => id !== contractToApprove)
        );
      }, 1000);
    }
  };
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to approve this contract? This action cannot
              be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            ...
            <div className="flex flex-col px-4">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="font-semibold">
                    {currentContract.delivery_address}
                  </p>
                </div>
                ...
                >
                  <div className="p-3 bg-green-50 border-b border-green-100">
                    ...
                    <p className="text-xs text-green-600">
                      Contracts waiting for your approval
                    </p>
                  </div>
                          ...
                          <div className="flex gap-2">
                            ...
                            {userRole === "farmer" &&
                              contract.status === "pending" && (
                                <Button
                                  onClick={() =>
                                    openApprovalDialog(contract.id)
                                  }
