...
import { AlertCircle, CalendarIcon, CheckCircle, Clock, FileText, Loader2, Upload } from "lucide-react"
...
export default function ContractPage() {
  ...
  const progressPercentage = Math.min(100, (totalPaid / totalContractValue) * 100)
          ...
          <Card className="mt-6">
            ...
            <CardContent>
              ...
              <div className="mt-6 space-y-4">
                ...
                <div className="flex items-start">
                  <div
                    className={`rounded-full p-1 ${hasPayments ? "bg-green-100 text-green-600" : "bg-muted text-muted-foreground"}`}
                  >
                ...
                <div className="flex items-start">
                  <div
                    className={`rounded-full p-1 ${progressPercentage >= 50 ? "bg-green-100 text-green-600" : "bg-muted text-muted-foreground"}`}
                  >
                ...
                <div className="flex items-start">
                  <div
                    className={`rounded-full p-1 ${progressPercentage >= 100 ? "bg-green-100 text-green-600" : "bg-muted text-muted-foreground"}`}
                  >
                    {progressPercentage >= 100 ? <CheckCircle className="h-4 w-4" /> : <Clock className="h-4 w-4" />}
                  </div>
                  <div className="ml-3">
